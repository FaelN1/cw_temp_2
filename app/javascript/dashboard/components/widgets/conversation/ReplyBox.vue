...
import ScheduleMessageModal from './bubble/ScheduleMessageModal.vue';
...
export default {
  ...
  methods: {
    ...
    toggleScheduleModal() {
      console.log('toggleScheduleModal chamado', this.showScheduleMessageModal);
      this.showScheduleMessageModal = !this.showScheduleMessageModal;
      console.log('após toggle', this.showScheduleMessageModal);
    },
    onClickSelfAssign() {
      const {
        account_id,
...
<template>
  <div class="reply-box" :class="replyBoxClass">
    ...
    <ReplyBottomPanel
      ...
      @open-schedule-modal="toggleScheduleModal"
    />
    <WhatsappTemplates
      :inbox-id="inbox.id"
